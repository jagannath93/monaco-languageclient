    ...
    server.forward(socketConnection, serverConnection, message => {
        if (rpc.isRequestMessage(message)) {
            if (message.method === lsp.InitializeRequest.type.method) {
                ...
                if(message.params.capabilities.textDocument) {
                    delete message.params.capabilities.textDocument.documentHighlight;
                    delete message.params.capabilities.textDocument.codeLens;
                    delete message.params.capabilities.textDocument.codeAction;
                }
